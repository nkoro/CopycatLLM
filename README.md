...
* **`dataset_curation/`**: Synthesizes the mixed-cohort API telemetry and routing environments.
* **`gatewaydefense/`**: Contains the core Zero-Trust gateway and token-level mitigation logic.
* **`evaluation/`**: Scripts to benchmark the defense's effectiveness against extraction attacks.
